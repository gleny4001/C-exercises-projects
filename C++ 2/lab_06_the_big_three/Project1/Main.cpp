...
int main()
{
	...
	cout << "TEST: OVERLOADED ASSIGNMENT OPERATOR\n";
	cout << "   => Objects have same number of nodes...\n\n";
	// Overloaded assignment operator: calling (1) - param (1)
	//testOverloadedAssignment(list1, list1, 11);								// TEST 11
	// Overloaded assignment operator: calling (2) - param (2)
	testOverloadedAssignment(list2, list2, 12);								// TEST 12
	// Overloaded assignment operator: calling (4) - param (4)
	testOverloadedAssignment(list4, list4, 13);								// TEST 13
	// Overloaded assignment operator: calling (7) - param (7)
	testOverloadedAssignment(list7, list7, 14);								// TEST 14

	cout << "\n--------------------------------------\n";

	cout << "TEST: OVERLOADED ASSIGNMENT OPERATOR\n";
	cout << "   => Calling object has more nodes...\n\n";
	// Overloaded assignment operator: calling (1) - param (empty)
	testOverloadedAssignment(list1, list0, 15);								// TEST 15
	...
	testOverloadedAssignment(list4, list0, 18);								// TEST 18
	// Overloaded assignment operator: calling (4) - param (1)
	testOverloadedAssignment(list4, list1, 19);								// TEST 19
	// Overloaded assignment operator: calling (4) - param (2)
	testOverloadedAssignment(list4, list2, 20);								// TEST 20
	// Overloaded assignment operator: calling (7) - param (empty)
	testOverloadedAssignment(list7, list0, 21);								// TEST 21
	// Overloaded assignment operator: calling (7) - param (1)
	testOverloadedAssignment(list7, list1, 22);								// TEST 22
	// Overloaded assignment operator: calling (7) - param (2)
	testOverloadedAssignment(list7, list2, 23);								// TEST 23
	// Overloaded assignment operator: calling (7) - param (4)
	testOverloadedAssignment(list7, list4, 24);								// TEST 24

	cout << "\n--------------------------------------\n";

	cout << "TEST: OVERLOADED ASSIGNMENT OPERATOR\n";
	cout << "   => Calling object has less nodes...\n\n";
	// Overloaded assignment operator: calling (1) - param (2)
	testOverloadedAssignment(list1, list2, 25);								// TEST 25
	// Overloaded assignment operator: calling (1) - param (4)
	testOverloadedAssignment(list1, list4, 26);								// TEST 26
	// Overloaded assignment operator: calling (1) - param (7)
	testOverloadedAssignment(list1, list7, 27);								// TEST 27
	// Overloaded assignment operator: calling (2) - param (4)
	testOverloadedAssignment(list2, list4, 28);								// TEST 28
	// Overloaded assignment operator: calling (2) - param (7)
	testOverloadedAssignment(list2, list7, 29);								// TEST 29
	// Overloaded assignment operator: calling (4) - param (7)
	testOverloadedAssignment(list4, list7, 30);								// TEST 30
...
void testCopyConstructor(DoublyList param, int n)
{
	...
	cout << "(print forward) Calling list: " << temp << endl;
	cout << "(print reverse) Calling list: ";
	temp.reversePrint();
